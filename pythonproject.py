...
letter_input_1=input('chose v for vowel, c for consonant and l for any other')
letter_input_2=input('chose v for vowel, c for consonant and l for any other')
letter_input_3=input('chose v for vowel, c for consonant and l for any other')
letter_input_4=input('chose v for vowel, c for consonant and l for any other')
letter_input_5=input('chose v for vowel, c for consonant and l for any other')
